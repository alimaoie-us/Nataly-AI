...
*Nataly Bot* is a smart, multi-purpose WhatsApp bot that allows media downloading, group management, searching, translation, and image/video processing. It was created by *ALI Maoie*, a tech enthusiast who enjoys modifying codes, and shares his ideas and projects on Instagram: 📸 instagram.com/ali_maoie_v`
  
  await conn.sendMessage(m.chat, {
    image: { url: 'https://files.catbox.moe/hnbuh3.jpg' },
    gifPlayback: true,
    caption,
    footer: '`NATALY Ai - 2025`',
